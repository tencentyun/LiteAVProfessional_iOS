              ...
              completion:^(int errCode, NSString *errMsg) {
                  ...
                  dispatch_async(dispatch_get_main_queue(), ^{
                      if (errCode == 0) {
                          ...
                          [self alertTips:LivePlayerLocalize(@"LiveLinkMicDemoOld.RoomPlayer.enterliveroomfailed")
                                      msg:errMsg
                               completion:^{
    ...
    dispatch_async(dispatch_get_main_queue(), ^{
        ...
        for (MLVBAnchorInfo *anchorInfo in pusherInfoArray) {
            ...
            [self->_liveRoom startRemoteView:anchorInfo
                ...
                playEvent:nil];
            // LOG
            [self appendLog:LocalizeReplaceThreeCharacter(LivePlayerLocalize(@"LiveLinkMicDemoOld.RoomPlayer.playxx"), [NSString stringWithFormat:@"%@", anchorInfo.userID],
