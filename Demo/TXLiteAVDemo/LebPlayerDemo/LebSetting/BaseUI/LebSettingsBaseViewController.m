...
- (void)setupTableView {
    ...
    [self.tableView registerClass:LebSettingsSwitchItem.bindedCellClass
           forCellReuseIdentifier:LebSettingsSwitchItem.bindedCellId];
    [self.tableView registerClass:LebSettingsSegmentItem.bindedCellClass
           forCellReuseIdentifier:LebSettingsSegmentItem.bindedCellId];
    [self.tableView registerClass:LebSettingsButtonItem.bindedCellClass
           forCellReuseIdentifier:LebSettingsButtonItem.bindedCellId];
    [self.tableView registerClass:LebSettingsSliderItem.bindedCellClass
           forCellReuseIdentifier:LebSettingsSliderItem.bindedCellId];
    [self.tableView registerClass:LebSettingsSelectorItem.bindedCellClass
           forCellReuseIdentifier:LebSettingsSelectorItem.bindedCellId];
