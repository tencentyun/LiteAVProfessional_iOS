...
- (void)setupYUVConversionProgram {
    self.yuvConversionProgram = [ShaderProcessor programWithShaderName:@"YUVConversion"];
}

- (void)setupNormalProgram {
    self.normalProgram = [ShaderProcessor programWithShaderName:@"Normal"];
}
