...
- (void)startRendering {
    ...
    CVPixelBufferCreate(kCFAllocatorDefault, CVPixelBufferGetWidth(self.pixelBuffer), CVPixelBufferGetHeight(self.pixelBuffer), format, (__bridge CFDictionaryRef)(pixelAttributes), &_pixelBufferNV12);
...
- (CVPixelBufferRef)renderByOpenGL:(CVPixelBufferRef)pixelBuffer {
    ...
    runSynchronouslyOnVideoProcessingQueue(^{
        ...
        output = [strongSelf.pixelBufferProcessor convertTextureToPixelBuffer:textureOutput.texture
                                                         textureSize:size];
