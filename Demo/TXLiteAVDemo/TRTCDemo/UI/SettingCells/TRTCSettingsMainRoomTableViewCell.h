...
- (instancetype)initWithRoomId:(NSString *)roomId isOn:(BOOL)isOn actionA:(void (^ _Nullable)(BOOL b, id cell))actionA actionTitle:(nonnull NSString *)actionTitle actionB:(void (^)(NSString * _Nullable content))actionB;
