...
- (void)setupUI {
    ...
    [_startButton setTitle:TRTCLocalize(@"Demo.TRTC.startSpeedTest")
...
- (void)beginSpeedTest {
    ...
    [self.cloudManager startSpeedTest:userId completion:^(TRTCSpeedTestResult * _Nonnull result, NSInteger completedCount, NSInteger totalCount) {
        ...
        if (completedCount == totalCount) {
            self.isSpeedTesting = false;
            [self.startButton setTitle:TRTCLocalize(@"Demo.TRTC.completedTest")
                              forState:UIControlStateNormal];
            return;
        }
