...
- (void)readVideoFrameFromTime:(float)startTime toTime:(float)endTime fps:(int)fps readOneFrame:(ReadOneFrame)readOneFrame readFinished:(ReadFinished)readFinished;
