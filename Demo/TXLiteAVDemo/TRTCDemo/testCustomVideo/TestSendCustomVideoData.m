    ...
    [weakSelf.mediaReader readVideoFrameFromTime:0
        ...
        readOneFrame:^(CMSampleBufferRef sampleBuffer) {
            ...
            if (self.streamType == 0) {
                [strongSelf.trtcCloud sendCustomVideoData:TRTCVideoStreamTypeBig frame:videoFrame];
            } else {
                [strongSelf.trtcCloud sendCustomVideoData:TRTCVideoStreamTypeSub frame:videoFrame];
            }
        }
        readFinished:^{
            __typeof(self) strongSelf = weakSelf;
