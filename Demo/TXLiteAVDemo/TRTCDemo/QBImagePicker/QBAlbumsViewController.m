...
- (UIImage *)placeholderImageWithSize:(CGSize)size {
    ...
    // Icon (back)
    CGRect backIconRect = CGRectMake(size.width * (16.0 / 68.0), size.height * (20.0 / 68.0), size.width * (32.0 / 68.0), size.height * (24.0 / 68.0));
    ...
    // Icon (front)
    CGRect frontIconRect = CGRectMake(size.width * (20.0 / 68.0), size.height * (24.0 / 68.0), size.width * (32.0 / 68.0), size.height * (24.0 / 68.0));
