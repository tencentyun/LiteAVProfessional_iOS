...
#import "ScreenPushV1ViewController.h"
...
@interface ScreenPushV1ViewController () <AddressBarControllerDelegate, ScanQRDelegate,
#ifndef DISABLE_VOD
TXVodPlayListener,
#endif
TXLivePushListener>
...
@implementation ScreenPushV1ViewController
...
- (void)initUI {
    ...
    self.btnReplaykit.bounds = CGRectMake(0, 0, 120, 50);
    self.btnReplaykit.titleLabel.adjustsFontSizeToFitWidth = true;
    self.btnReplaykit.backgroundColor = UIColor.lightTextColor;
    self.btnReplaykit.layer.cornerRadius = 5;
    [self.btnReplaykit setTitleEdgeInsets:UIEdgeInsetsMake(0, 5, 0, 5)];
    ...
    micControlButton.bounds = CGRectMake(0, 0, 120, 50);
    micControlButton.titleLabel.adjustsFontSizeToFitWidth = true;
    micControlButton.backgroundColor = UIColor.lightTextColor;
    micControlButton.layer.cornerRadius = 5;
    [micControlButton setTitleEdgeInsets:UIEdgeInsetsMake(0, 5, 0, 5)];
    [micControlButton setTitle:LivePlayerLocalize(@"LivePusherDemo.ScreenPush.mutevocalcapture") forState:UIControlStateNormal];
    [micControlButton setTitle:LivePlayerLocalize(@"LivePusherDemo.ScreenPush.turnonvocalcapture") forState:UIControlStateSelected];
...
- (void)addressBarControllerTapCreateURL:(AddressBarController *)controller {
    ...
    __weak ScreenPushV1ViewController *weakSelf = self;
...
- (void)clickStartReplaykit:(UIButton *)btn {
    ...
    if (isStart) {
        ...
        if (!isCaptured) {
            ...
            UIAlertAction *action1 = [UIAlertAction actionWithTitle:LivePlayerLocalize(@"LiveLinkMicDemoOld.RoomList.determine") style:UIAlertActionStyleDefault handler:^(UIAlertAction * _Nonnull action) {
                if (@available(iOS 11.0, *)) {
                    [weakSelf.livePusher startScreenCaptureByReplaykit:kReplayKit2AppGroupId];
                }
                [weakSelf refreshResolutionAndRotation];
                [weakSelf.livePusher startPush:weakSelf.addressBarController.text];
