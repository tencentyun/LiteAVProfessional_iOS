...
- (instancetype)initWithFrame:(CGRect)frame {
    if (self = [super initWithFrame:frame]) {
        ...
        _loopTimesFiled           = [[UITextField alloc] initWithFrame:CGRectMake(loopTimesLabel.right, loopTimesLabel.top, 50, height)];
        _loopTimesFiled.text      = @"1";
        _loopTimesFiled.textColor = [UIColor whiteColor];
        _loopTimesFiled.delegate  = self;

        UILabel *onlineLabel  = [[UILabel alloc] initWithFrame:CGRectMake(self.width - 160, loopTimesLabel.top, 100, height)];
        ...
        UISlider *micVolumeSlider    = [[UISlider alloc] initWithFrame:CGRectMake(micVolumeLabel.right, micVolumeLabel.top, self.width - micVolumeLabel.right - offsetX, height)];
        ...
        UILabel *bgmVolumeLabel      = [[UILabel alloc] initWithFrame:CGRectMake(offsetX, micVolumeLabel.bottom + 10, micVolumeLabel.width, height)];
        bgmVolumeLabel.text          = LivePlayerLocalize(@"LivePusherDemo.PushBgm.bgmvolume");
        bgmVolumeLabel.textColor     = [UIColor whiteColor];
        UISlider *bgmVolumeSlider    = [[UISlider alloc] initWithFrame:CGRectMake(bgmVolumeLabel.right, bgmVolumeLabel.top, self.width - bgmVolumeLabel.right - offsetX, height)];
        ...
        UILabel *bgmPitchLabel      = [[UILabel alloc] initWithFrame:CGRectMake(offsetX, bgmVolumeLabel.bottom + 10, bgmVolumeLabel.width, height)];
        bgmPitchLabel.text          = LivePlayerLocalize(@"LivePusherDemo.PushBgm.bgmtone");
        bgmPitchLabel.textColor     = [UIColor whiteColor];
        UISlider *bgmPitchSlider    = [[UISlider alloc] initWithFrame:CGRectMake(bgmPitchLabel.right, bgmPitchLabel.top, self.width - bgmVolumeLabel.right - offsetX, height)];
        ...
        UIButton *startBtn = [[UIButton alloc] initWithFrame:CGRectMake(60, bgmPitchLabel.bottom + 10, 60, height)];
