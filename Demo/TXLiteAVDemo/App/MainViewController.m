...
- (void)initCellInfos
{
    ...
    cellInfo.subCells = ({
        ...
        scellInfo.navigateToController = @"ScreenPushViewController";
        [subCells addObject:scellInfo];
#endif
...
- (void)qb_imagePickerController:(QBImagePickerController *)imagePickerController didFinishPickingAssets:(NSArray *)assets
{
    ...
    if ([cellInfo.title isEqualToString:@"特效编辑"] || [cellInfo.title isEqualToString:@"图片转场"]) {
        ...
        loadvc.composeMode = ComposeMode_Video_Upload;
    } else if ([cellInfo.title isEqualToString:@"图片上传"]) {
        loadvc.composeMode = ComposeMode_Image_Upload;
    }
    else return;
