...
///禁用本地存储（AVChatRoom,BChatRoom 消息数量很大，出于程序性能的考虑，disableStorage 无论设不设置，消息都不存本地）
...
///离线 Push 展示标题,针对 iOS 和 Android 平台都生效，如果您需要分平台单独设置，请设置 iosConfig -> title 和 androidConfig -> title
@property(nonatomic,strong) NSString * title;

///离线 Push 展示自定义文本，针对 iOS 和 Android 平台都生效,如果您需要分平台单独设置，请设置 iosConfig -> desc 和 androidConfig -> desc
@property(nonatomic,strong) NSString * desc;
